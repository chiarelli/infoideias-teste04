...
$router->add("/ajax/noticas",                    array("controller" => "Noticia", "action"          => "listarAjax"))->setName('ajax.noticia.listar');
...
$router->addPost("/noticias/update",             array("controller" => "Noticia",  "action"   => "update"))->setName('noticia.update');
